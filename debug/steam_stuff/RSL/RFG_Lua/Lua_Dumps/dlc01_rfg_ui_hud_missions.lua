...
function rfg_ui_hud_missions_init()
	...
	vint_dataitem_add_subscription( "HudHostageInfo", "update", "hostages_update")
...
-- ##############################################################
function hostages_update(data_item_handle, event_name)
	local visible, hostage_state_1, hostage_state_2, hostage_state_3 = vint_dataitem_get(data_item_handle)
	...
	if (visible == false) then
		...
		for i = 1, 3 do
			...
			--convert the correct string to a number
			if( i == 1 )then
				hostage_state = hostage_state_1
			elseif( i == 2 )then
				hostage_state = hostage_state_2
			elseif( i == 3 )then
				hostage_state = hostage_state_3
			end
