...
function set_loading_info(data_item_handle, event_name)
	local index, layout_type, bg_image, image_rot, fg1_image, fg1_rot, fg2_image, fg2_rot, text1, text2, text3, text4, text5, ol_bg_image, ol_rotation, ol_fg1_image, 
				ol_fg1_rot, ol_string1, ol_string2, ol_string3, ol_string4, ol_string5, multiplayer_tip = vint_dataitem_get(data_item_handle)
	...
	-- multiplayer tip
	if (multiplayer_tip ~= nil) then
		vint_set_property(vint_object_find("cycle_hints"), "text_tag", multiplayer_tip)
		vint_set_property(vint_object_find("cycle_hints_shadow"), "text_tag", multiplayer_tip)
		vint_set_property(vint_object_find("loading_hints"), "visible", true)
	else
		vint_set_property(vint_object_find("loading_hints"), "visible", false)
	end
