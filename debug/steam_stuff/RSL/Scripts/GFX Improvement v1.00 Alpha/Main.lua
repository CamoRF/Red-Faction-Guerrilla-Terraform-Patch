...
--LOGGING	
	rsl.Log("Graphics Improvement v1.00 24-2-2023 Build 547 Loaded\n")
...
--GENERAL
	rfg.Misc.DistortionScale = 0.09                                   --Default 0.09
	rfg.Misc.DistortionBlurScale = 2.00                               --Default 2.00
...
--CLOUD SHADOWS
	rfg.Shadows.CloudShadowScale = 0.425                               --Default 0.5
	rfg.Shadows.CloudShadowIntensityScale = 4.25                       --Default 4.5
